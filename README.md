...
| [`dataset-ml`](crates/dataset-ml)            | `crates/dataset-ml`        | Ready-to-use loaders for 24 classic ML datasets (Iris, Adult, Titanic, Covtype, Abalone, SMS Spam, …), built on `dataset-core` |
