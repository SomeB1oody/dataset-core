...
## [0.1.0] - 2026-4-7
### Changed
- Add feature gating for `utils` and `datasets`, update examples and tests, and modularize optional dependencies
...
## [0.1.0] - 2026-4-2
### Changed
- Refactor dataset modules to streamline loader methods and simplify `Dataset` trait bound and putting downloading and parsing process in one method

## [0.1.0] - 2026-4-1
### Changed
- Refactor dataset modules to use `Dataset` struct for unified lazy loading and caching logic
