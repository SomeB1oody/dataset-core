...
| [`dataset-ml`](crates/dataset-ml)         | `crates/dataset-ml`        | 基于 `dataset-core` 的 12 个经典 ML 数据集开箱即用加载器：Iris、Breast Cancer、Boston/California Housing、Diabetes、Digits、Linnerud、Titanic、Palmer Penguins、Wine Recognition、红/白葡萄酒质量数据集 |
