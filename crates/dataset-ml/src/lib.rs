...
pub use dataset::{
    ...
    movie_review_polarity::MovieReviewPolarity, movielens_100k::MovieLens100k, mushroom::Mushroom,
    newsgroups20::Newsgroups20, palmer_penguins::PalmerPenguins,
    sentiment_sentences::SentimentSentences, sms_spam::SmsSpam, spambase::Spambase,
    titanic::Titanic, wholesale_customers::WholesaleCustomers,
